...
public class LibrosFavoritosController {
	...
	public ResponseEntity<List<LibrosFavoritos>> getAllLibrosFavoritos() {
		return new ResponseEntity<List<LibrosFavoritos>> ( this.service.listAllLibrosFavoritos(), HttpStatus.OK);
	}
	
	@GetMapping(value="libro-favorito-id", produces = MediaType.APPLICATION_JSON_VALUE)
	public LibrosFavoritos getByIdLibrosFavoritos(@RequestParam("idLibroFavorito") int id) {
		return this.service.findIdLibrosFavoritos(id);
	}
	
	@PostMapping(value="add-libro-favorito", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public LibrosFavoritos postLibrosFavoritos(@RequestBody LibrosFavoritos newLibrosFavoritos) {
		return this.service.addLibrosFavoritos(newLibrosFavoritos);
	}
	...
	public LibrosFavoritos putLibrosFavoritos(@RequestBody LibrosFavoritos updateLibrosFavoritos) {

...
public class DatoUsuarioController {
	...
	public ResponseEntity<List<DatosUsuarios>> getAllDatosUsuarios() {
		return new ResponseEntity<List<DatosUsuarios>> ( this.service.listAllDatosUsuarios(), HttpStatus.OK);
	}
	
	@GetMapping(value="dato-usuario-id", produces = MediaType.APPLICATION_JSON_VALUE)
	public DatosUsuarios getByIdDatoUsuario(@RequestParam("idDatoUsuario") int id) {
		return this.service.findIdDatoUsuario(id);
	}
	
	@PostMapping(value="add-dato-usuario", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public DatosUsuarios postDatoUsuario(@RequestBody DatosUsuarios newDatoUsuario) {
		return this.service.addDatoUsuario(newDatoUsuario);
	}
	
	@PutMapping(value="update-dato-usuario", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public DatosUsuarios putDatoUsuario(@RequestBody DatosUsuarios updateDatoUsuario) {
		return this.service.updDatoUsuario(updateDatoUsuario);
	}

...
export class CalificacionService {
  ...
  public getCalificacionesById(
    requestBody: number
  ): Observable<calificacionesByLibroId[]> {
    return this.http.post<calificacionesByLibroId[]>(
      `${this.endPoint}/calificaciones-libro`,
      requestBody,
      this.options
    );
  }
  ...
  public getAllCalificaciones(): Observable<CalificacionLibro[]> {
    return this.http.get<CalificacionLibro[]>(
      `${this.endPoint}/calificaciones`,
      this.options
    );
  }

  public createCalificacion(
    requestBody: CalificacionLibro
  ): Observable<CalificacionLibro> {
    return this.http.post<CalificacionLibro>(
      `${this.endPoint}/add-calificacion`,
      requestBody,
      this.options
    );
  }
